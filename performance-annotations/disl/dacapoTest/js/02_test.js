(function($) {
  ...
  $.fn.wpcf7NotValidTip = function(message) {
    return this.each(function() {
      ...
      $into.append('<span role="alert" class="wpcf7-not-valid-tip">' + message +
                   '</span>');
  ...
  $.fn.wpcf7RefillCaptcha = function(captcha) {
    return this.each(function() {
      ...
      $.each(captcha, function(i, n) {
        ...
        form.find('input:hidden[name="_wpcf7_captcha_challenge_' + i + '"]')
            .attr('value', match[1]);
      });
    });
  };
    ...
    return this.each(function() {
      ...
      $.each(quiz, function(i, n) {
        ...
        form.find(':input[name="' + i + '"]')
            ...
            .text(n[0]);
        form.find('input:hidden[name="_wpcf7_quiz_answer_' + i + '"]')
            .attr('value', n[1]);
      });
    });
  };
    ...
    return this.each(function() {
      ...
      $(this).closest('div.wpcf7').on(events, function(e) {
        if (recaptchaWidgets && grecaptcha) {
          $.each(recaptchaWidgets,
                 function(index, value) { grecaptcha.reset(value); });
        }
      });
    });
  };
