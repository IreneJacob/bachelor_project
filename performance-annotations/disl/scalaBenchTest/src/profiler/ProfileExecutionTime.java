   ...
   private ProfileExecutionTime(){/*Prevent instantiation*/}
	...
	return variance;
     ...
     private static void print_values(String pname) {
             try{
                 final Path completed = FileSystems.getDefault().getPath("./logs/actors","Values.dat");
...
//             PrintWriter out = new PrintWriter(Files.newBufferedWriter(completed));
     ...
     static {
         ...
         Runtime.getRuntime().addShutdownHook(new Thread(() -> {
             try{
                 final Path completed = FileSystems.getDefault().getPath("./logs/actors","Index.dat");
                 PrintWriter out = new PrintWriter(Files.newBufferedWriter(completed));
        ...
        //  print_values("");
		//  print_values("org/h2/schema/Schema.getAll");
